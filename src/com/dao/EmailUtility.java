...
public class EmailUtility {
   ...
   public static void sendMail(EmailMessage emailMessageDTO) throws ActivationException{
     final String sender_Email = "pppisal@gmail.com";
     final String sender_email_pass = "83655651904";
       try {
