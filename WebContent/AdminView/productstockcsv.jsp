...
{
	int sno=0;
String query = "Select * from producttb1 where product_name like '%"+category+"%' or product_category like '%"+category+"%' or product_subcat like '%"+category+"%' or product_type like '%"+category+"%'";
