...
<tr>
<th align="left"><Span style="font-size:35px;">Search DateWise Records</Span>
<%
if(form_date!=null&&to_date!=null)
{
%>
<button class="bt1" ><i class="fa fa-download" aria-hidden="true"></i> <a href="datewiseorder.jsp?form_date=<%= form_date %>&&to_date=<%=to_date %>" style="color:black;">Export Data</a></button>
...
From Date:<input type="date" name="form_date" id="datepicker" class="inp">
To Date: <input type="date" name="to_date" id="datepicker1" class="inp">
...
<tbody>
<%
List<Order> list=dao.getAllOrderDatewise(form_date,to_date);
