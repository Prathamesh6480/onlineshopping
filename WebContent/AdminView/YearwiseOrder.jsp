...
String form_date = request.getParameter("year"); %>
<table style="width:100%;">

<tr>
<th align="left"><Span style="font-size:35px;"> Search Year Wise Records</Span>
<%
if(form_date!=null)
{
%>
<button class="bt1" ><i class="fa fa-download" aria-hidden="true"></i> <a href="yearordercsv.jsp?year=<%= form_date %>" style="color:black;">Export Data</a></button>
...
Year:<input type="text" name="year" id="datepicker"  class="inp">
...
List<Order> list=dao.getAllOrderYearwise(form_date);
