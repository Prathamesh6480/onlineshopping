...
<dl>
  ...
  <dt><a href="Homedecors.jsp">Home Decors Product</a> </dt>
...
<h1 class="price">Home Decoration product</h1>
<%
UserRegister user=(UserRegister)session.getAttribute("currentUser");
%>
<%
ProductDao dao=new ProductDao(ConnectionProvider.getConnection());
List<AddProduct>list=dao.getHomeDecorProduct();
...
<span style="color:Lime"><%= ap.getProduct_discount() %></span> <span style="color:Lime">% off</span>  </h3>
   <p class="description"><span style="font-size:15px;color:red" >save &#8377 <%= ap.getDiscount_price() %></span></p>
